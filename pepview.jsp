	...
	<div class="content">
		...
		<div id="main">
			...
			<br/>
				...
				<center><a href="services?action=<s:property value="action"/>" style="font-size: 35px; color:#4fb6e5; font-family:Monotype Corsiva;text-decoration:none">Submit Policy</a></center>
				<br/>			
			</div>
		</div>
